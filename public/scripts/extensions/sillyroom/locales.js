...
export const SILLYROOM_LOCALES = {
    'en': {
        ...
        // one-click actions & large window (P2-4)
        '放大/还原': 'Maximize/Restore',
        '复制邀请信息发给朋友': 'Copy an invite to send to your friend',
        '邀请信息已复制，发给朋友即可': 'Invite copied — send it to your friend',
        '复制失败，请手动复制邀请信息：': 'Copy failed — please copy the invite manually:',
        '来 SillyTavern 聊天室聊天！地址：${0}，房间码：${1}${2}': 'Come chat in the SillyTavern chatroom! Address: ${0}, room code: ${1}${2}',
        '，密码：${0}': ', password: ${0}',
        'AI 加入': 'Add AI',
        '移除 AI': 'Remove AI',
        '一键让本地 AI 参与房间聊天：注入真人发言 + 广播 AI 回复 + 自动回应（再次点击全部关闭）': 'One click to let the local AI join the room: inject member messages + relay AI replies + auto-respond (click again to turn all three off)',
        '请先选择一个角色，AI 才能加入聊天': 'Select a character first so the AI can join the chat',
        // messages
    ...
    'zh-tw': {
        ...
        // one-click actions & large window (P2-4)
        '放大/还原': '放大/還原',
        '复制邀请信息发给朋友': '複製邀請資訊發給朋友',
        '邀请信息已复制，发给朋友即可': '邀請資訊已複製，發給朋友即可',
        '复制失败，请手动复制邀请信息：': '複製失敗，請手動複製邀請資訊：',
        '来 SillyTavern 聊天室聊天！地址：${0}，房间码：${1}${2}': '來 SillyTavern 聊天室聊天！地址：${0}，房間碼：${1}${2}',
        '，密码：${0}': '，密碼：${0}',
        'AI 加入': 'AI 加入',
        '移除 AI': '移除 AI',
        '一键让本地 AI 参与房间聊天：注入真人发言 + 广播 AI 回复 + 自动回应（再次点击全部关闭）': '一鍵讓本地 AI 參與房間聊天：注入真人發言 + 廣播 AI 回覆 + 自動回應（再次點擊全部關閉）',
        '请先选择一个角色，AI 才能加入聊天': '請先選擇一個角色，AI 才能加入聊天',
        // messages
        '—— 断线期间的新消息 ——': '—— 斷線期間的新訊息 ——',
        '⏳ 待发送': '⏳ 待傳送',
        '、': '、',
